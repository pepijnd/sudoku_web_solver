...
fn killer_benchmark(c: &mut Criterion) {
    ...
    let mut config = Config {
        rules: Rules {
            cages: Cages {
                cages: vec![
                    15, 7, 15, 25, 5, 13, 6, 12, 4, 11, 9, 8, 5, 12, 23, 33, 16, 12, 9, 1, 5, 12,
                    14, 22, 13, 18, 9, 8, 8, 25, 8, 6, 7, 9,
                ],
                cells: [
                    1, 1, 2, 2, 3, 3, 4, 4, 4, 5, 6, 6, 2, 3, 7, 4, 8, 9, 5, 10, 10, 11, 12, 13,
                    13, 8, 9, 14, 15, 15, 16, 16, 16, 16, 17, 17, 14, 15, 18, 18, 18, 16, 19, 19,
                    17, 20, 21, 21, 22, 22, 16, 19, 23, 24, 25, 26, 26, 22, 27, 28, 28, 23, 24, 25,
                    26, 29, 30, 30, 30, 31, 31, 24, 32, 26, 29, 33, 33, 30, 31, 34, 24,
                ],
            },
        },
        ..Default::default()
    ...
    group.bench_with_input("sudoku", &config, |b, c| {
        b.iter(|| {
            let config = c.clone();
            black_box(sudoku.solve(Some(config)));
        })
    });
